...
- [/net7 Endpoints](#net7-endpoints)
  ...
  - [Get /net7/string/{id}](#get-net7stringid)
...
- [IProblemDetailsService](https://devblogs.microsoft.com/dotnet/asp-net-core-updates-in-dotnet-7-preview-7/#new-problem-details-service) (doc) for errors in [RFC7807](https://www.rfc-editor.org/rfc/rfc7807) format
  - [Program.cs](Program.cs#L24)
- [Raw String literals](https://learn.microsoft.com/en-us/dotnet/csharp/programming-guide/strings/#raw-string-literals) (doc)
  - [Program.cs](Program.cs#L116)
  - [VariableBase.cs](Models/VariableBase.cs#L76)
- [Simplified Auth for Minimal API](https://auth0.com/blog/whats-new-in-dotnet-7-for-authentication-and-authorization/) (doc)
  - [Program.cs](Program.cs#L29)
- [dotnet user-jwts](https://learn.microsoft.com/en-us/aspnet/core/security/authentication/jwt-authn) (doc)
  - [BuilderExtensions.cs](BuilderExtensions.cs)
- [Polymorphic JSON Serialization](https://devblogs.microsoft.com/dotnet/system-text-json-in-dotnet-7/#type-hierarchies) (doc)
  - [VariableBase.cs](Models/VariableBase.cs#L16)
- [file](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/file) (doc) keyword
  - [TestService.cs](Service\TestService.cs#L4)
...
Demonstrates JSON Serialization of derived types and if id < 100 throws an error. See below.
...
Demonstrates new string features. 1-5 for id. Anything else is 404

This calls all the string variations. The last one will get a 404
...
Not a .NET 7 feature, this was added to this project to test IFeatureManager. The endpoints for it are as follows

| Endpoint     | Description                                         |
| ------------ | --------------------------------------------------- |
| /flags       | Test of a feature that switches depending on a flag |
| /fm          | Get a few flags                                     |
| /fm/context  | Get flags from FeatureManager with context          |
| /fm/context  | Get flags from FeatureManger with no context        |
| /fm/snapshot | Get flags FeatureManagerSnapshot                    |

These are the flags and values
